class b extends HTMLElement {
  ...
  get activeStaggeredDelay() {
    return this.staggeredDelay !== void 0
      ? this.staggeredDelay
      : this.effectiveReduceAnimation
        ? 35
        : 50;
  }
  get activeAnimationSpeed() {
    return this.animationSpeed !== void 0
      ? this.animationSpeed
      : this.effectiveReduceAnimation
        ? 900
        : 600;
  ...
  get activeOscillateDistance() {
    return this.oscillateDistance !== void 0
      ? this.oscillateDistance
      : this.effectiveReduceAnimation
        ? '3%'
        : '2%';
  }
  get columnStructures() {
    const e = this.gridSize,
      l = [],
      d = 32;
    let a, s, i, r;
    e === 32
      ? ((a = [6, 25]), (s = [13, 18]), (i = [13, 18]), (r = [6, 25]))
      : e === 15
        ? ((a = [3, 11]), (s = [6, 8]), (i = [6, 8]), (r = [3, 11]))
        : ((a = [1, 3]), (s = [2, 2]), (i = [2, 2]), (r = [1, 3]));
    const u = t => {
        if (e === 32) return 1;
  ...
  render() {
    const e = this.columnStructures,
      l = this.activeStaggeredDelay,
      d = this.gridSize,
      a = e
        .map(
          (i, r) =>
